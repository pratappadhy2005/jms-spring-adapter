...
public class BatchMessageListenerContainer extends DefaultMessageListenerContainer {
    ...
    protected void doExecuteListener(Session session, List<Message> messages) throws JMSException {
        ...
        org.bsnyder.spring.jms.batch.SessionAwareBatchMessageListener<Message> lsnr =
                (org.bsnyder.spring.jms.batch.SessionAwareBatchMessageListener<Message>) getMessageListener();
    ...
    protected void checkMessageListener(Object messageListener) {
        if (!(messageListener instanceof org.bsnyder.spring.jms.batch.SessionAwareBatchMessageListener<?>)) {
            throw new IllegalArgumentException("Message listener needs to be of type ["
                    + org.bsnyder.spring.jms.batch.SessionAwareBatchMessageListener.class.getName() + "]");
        }
    }
